...
const steps = [
  ...
  { n: '04', title: 'Deploy', desc: 'We coordinate contracting, provisioning, deployment and ongoing infrastructure support. You contract directly with provider.' },
]
      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8 relative">
        <div className="text-center max-w-[720px] mx-auto">
          ...
          <p className="text-muted text-[16px] mt-4">
            This section is critical because visitors should immediately understand why they should come to us instead of approaching individual GPU providers.
          </p>
        </div>

        <div className="relative mt-16">
          {/* connecting line */}
          <div className="hidden lg:block absolute top-[28px] left-[12%] right-[12%] h-px bg-gradient-to-r from-border via-accent/30 to-border" />
            ...
            {steps.map((s, i) => (
              ...
              >
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-9 h-9 rounded-full bg-bg border border-border flex items-center justify-center font-mono text-[12px] font-bold text-accent">
                    {s.n}
                  </div>
                  <div className="h-px flex-1 bg-border lg:hidden" />
                  <div className="hidden lg:block w-8 h-8 rounded-full bg-accent/10 border border-accent/20 flex items-center justify-center">
                    <span className="text-accent text-[12px]">→</span>
                  </div>
                </div>
                <h3 className="font-display font-semibold text-[16px] leading-tight">{s.title}</h3>
        ...
        <div className="mt-16 rounded-2xl bg-bg border border-border p-6 lg:p-8 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          <div>
